...
public class D_ArraysKey {
    ...
    public int maxValue(int[] arr){
        // Write a method that takes an array of integers and returns the maximum value that the array contains
        int max = arr[0];
    ...
    public int sumArray(int[] arr){
        // Write a method that takes an array of integers and returns the sum of all of the elements
        int sum = 0;
        for(int i = 0; i < arr.length; i++){
            sum += arr[i];
        }
    ...
    public String longestString(String[] arr){
        // Write a method that takes an array of Strings and returns the logest one
    ...
    public double averageValue(double[] arr){
        // Write a method that takes an array of integers and returns the average
        double sum = 0;
